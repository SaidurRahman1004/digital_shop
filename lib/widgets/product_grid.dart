...
class ProductGrid extends StatelessWidget {
  ...
  const ProductGrid({super.key, this.category, this.products});
  ...
  final List<Map<String, dynamic>> _allProducts = const [
    ...
    },
    {
      ...
      'price': 49.00,
      'image':
          'https://images.unsplash.com/photo-1501504905252-473c47e087f8?q=80&w=1974',
      'status': 'Sold Out',
      'validity': '1 Month',
      'description':
          'Enjoy ad-free music for up to 6 family members living under one roof with Spotify Family plan.',
    ...
    },
    {
      ...
      'price': 14.99,
      'image':
          'https://images.unsplash.com/photo-1580327344181-c1163234e5a0?q=80&w=1974',
      'status': 'Coming Soon',
      'validity': '1 Month',
      'description':
          'Enjoy ad-free music for up to 6 family members living under one roof with Spotify Family plan.',
    },
    {
      ...
      'price': 20.99,
      'image':
          'https://images.unsplash.com/photo-1558153493-a232a03dccc7?q=80&w=1974',
      'badge': '15% Off',
      'status': 'Stock Out',
      'validity': '1 Month',
      'description':
